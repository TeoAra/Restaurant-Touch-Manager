    ...
    <div className="w-56 bg-sidebar h-screen flex flex-col shrink-0 select-none">
      ...
      <div className="p-3 border-t border-sidebar-border shrink-0 space-y-1">
        ...
        <button onClick={logout}
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sidebar-foreground/60 hover:text-white hover:bg-sidebar-accent transition-colors text-sm">
